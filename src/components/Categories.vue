<template>
  <div class="categories">
    <ul>
      <li @click="handleSetNull" :class="{ active: categoryActive === null }">Все</li>
      <li
...
export default {
  setup() {
    ...
    const categories = ref(['Мясные', 'Вегетарианская', 'Гриль', 'Острые', 'Закрытые']);
    ...
    return { categories, categoryActive, handleActiveItem, handleSetNull };
  },
};
</script>
