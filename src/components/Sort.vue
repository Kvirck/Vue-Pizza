<template>
  <div class="sort">
    <div class="sort__label">
      ...
      <b>Сортировка по:</b>
      <span @click="showPopup = !showPopup">{{ sortItems[activeSortItem.id].name }}</span>
    </div>
